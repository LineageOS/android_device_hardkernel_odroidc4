...
else ifneq ("$(wildcard vendor/amlogic/odroidc4/radio/bootloader-recovery.img)","")
	$(hide) $(call aml-copy-install-file, vendor/amlogic/odroidc4/radio/bootloader-recovery.img, u-boot.bin)
else
